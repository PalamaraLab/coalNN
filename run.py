...
import os
import numpy as np
from runners.runner_msprime import MsprimeRunner
...
if __name__ == '__main__':
    ...
    options.add_argument('--size', type=str, default='', help='Number of diploid individuals to process')
    options.add_argument('--simulation_size', type=str, default='', help='Sample size to be used by msprime for simulation')
    ...
    options.add_argument('--batch_size', type=int, default='64', help='Batch size.')
    options = options.parse_args()

    runner = MsprimeRunner(options)
    runner.run()
